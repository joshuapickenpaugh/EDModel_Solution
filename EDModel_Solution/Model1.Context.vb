...
Partial Public Class CSE_DEPT_TYPED_INEntities
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=CSE_DEPT_TYPED_INEntities")
    End Sub
    ...
    Public Overridable Property Course_TYPED_IN() As DbSet(Of Course_TYPED_IN)
    Public Overridable Property Faculty_TYPED_IN() As DbSet(Of Faculty_TYPED_IN)
    Public Overridable Property LogIn_TYPED_IN() As DbSet(Of LogIn_TYPED_IN)
    Public Overridable Property Student_TYPED_IN() As DbSet(Of Student_TYPED_IN)
    Public Overridable Property StudentCourse_TYPED_IN() As DbSet(Of StudentCourse_TYPED_IN)
